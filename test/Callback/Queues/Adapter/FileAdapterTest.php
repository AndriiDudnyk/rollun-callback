...
namespace rollun\test\Callback\Queues\Adapter;
...
class FileAdapterTest extends TestCase
{
    ...
    {
        return new FileAdapter('/tmp/test', $timeInFlight);
    }
    ...
    public function testCreateQueue()
    {
        ...
        $this->assertTrue(file_exists('/tmp/test/5a.queue'));
    }
    ...
    public function testCreteSameQueueSuccess()
    {
        ...
        $object->createQueue('a');
        $this->assertTrue(file_exists('/tmp/test/10a.queue'));
    }
